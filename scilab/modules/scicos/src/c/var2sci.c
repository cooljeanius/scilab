...
int var2sci(void *x, int n, int m, int typ_var)
{
    ...
    ************************************/
    ...
    {
        nm = (int)(ceil((double)((n * m) / 2)) + 1);    /*int*/
    }
    else if (typ_var == SCSINT8_N)
    {
        nm = (int)(ceil((double)((n * m) / 8)) + 1);    /*int8*/
    }
    else if (typ_var == SCSINT16_N)
    {
        nm = (int)(ceil((double)((n * m) / 4)) + 1);    /*int16*/
    }
    else if (typ_var == SCSINT32_N)
    {
        nm = (int)(ceil((double)((n * m) / 2)) + 1);    /*int32*/
    }
    else if (typ_var == SCSUINT_N)
    {
        nm = (int)(ceil((double)((n * m) / 2)) + 1);    /*uint*/
    }
    else if (typ_var == SCSUINT8_N)
    {
        nm = (int)(ceil((double)((n * m) / 8)) + 1);    /*uint8*/
    }
    else if (typ_var == SCSUINT16_N)
    {
        nm = (int)(ceil((double)((n * m) / 4)) + 1);    /*uint16*/
    }
    else if (typ_var == SCSUINT32_N)
    {
        nm = (int)(ceil((double)((n * m) / 2)) + 1);    /*uint32*/
    }
