...
*/
DYNAMIC_LINK_IMPEXP void GetDynFunc(int ii, void (**realop)(void));
...
* @param
*/
DYNAMIC_LINK_IMPEXP int SearchInDynLinks(char *op, void (**realop)(void));
...
* @return id
*/
DYNAMIC_LINK_IMPEXP int scilabLink(int idsharedlibrary, char *filename,
