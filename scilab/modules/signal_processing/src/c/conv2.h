 ...
 */
extern void conv2_separable_R(double *R, int nR,
                              double *C, int nC,
 ...
 */
extern void conv2_separable_C(double *Rr, double *Ri, int nR,
 ...
 * edgN is an integer
 */
extern void conv2_R(double *A, int mA, int nA,
 ...
 * edgN is an integer
 */
extern void conv2_C(double *Ar, double *Ai, int mA, int nA,
