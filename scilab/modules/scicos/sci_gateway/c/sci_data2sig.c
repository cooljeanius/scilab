    ...
    *Lstk(Top + 1)  = l + 1;
    ...
    switch (il1[0])
    {
        ...
        case 8 :
        {
            ...
            *istk(il + 3)    = it;
            if (it == 4)
            {
                ...
                *Lstk(Top + 1) = l + (int)(ceil((double)((n1 * m1) / 2)) + 1);
            }
            else if (it == 2)
            {
                for (i = 0; i < (m1 * n1); i++)
                ...
                *Lstk(Top + 1) = l + (int)(ceil((double)((n1 * m1) / 4)) + 1);
            }
            else if (it == 1)
            {
                for (i = 0; i < (m1 * n1); i++)
                ...
                *Lstk(Top + 1) = l + (int)(ceil((double)((n1 * m1) / 8)) + 1);
            }
            else if (it == 14)
            {
                for (i = 0; i < (m1 * n1); i++)
        ...
        case 17 :
        {
            ...
            *Lstk(Top + 1) = l + (int)(ceil((double)((n2h) / 2)) + 1);
                ...
                case 8 :
                {
                    ...
                    *istk(il + 3)    = it;
                    if (it == 4)
                    {
                        ...
                        *Lstk(Top + 1) = l + (int)(ceil((double)((n1 * m1 * p1) / 2)) + 1);
                    }
                    else if (it == 2)
                    {
                        for (i = 0; i < (m1 * n1 * p1); i++)
                        ...
                        *Lstk(Top + 1) = l + (int)(ceil((double)((n1 * m1 * p1) / 4)) + 1);
                    }
                    else if (it == 1)
                    {
                        for (i = 0; i < (m1 * n1 * p1); i++)
                        ...
                        *Lstk(Top + 1) = l + (int)(ceil((double)((n1 * m1 * p1) / 8)) + 1);
                    }
                    else if (it == 14)
                    {
                        for (i = 0; i < (m1 * n1 * p1); i++)
