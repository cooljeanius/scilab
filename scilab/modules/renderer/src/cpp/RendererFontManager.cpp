...
int changeFont(int index, char * fontName)
{
    ...
    if (fntmgr)
    {
        fontID = (int)fntmgr->changeFont(index, fontName);
        delete fntmgr;
    }
...
int changeFontWithProperty(int index, char * fontName, BOOL isBold, BOOL isItalic)
{
    ...
    if (fntmgr)
    {
        fontID = (int)fntmgr->changeFontWithProperty(index, fontName,
                 BOOLtobool(isBold),
                 BOOLtobool(isItalic));
        delete fntmgr;
    }
...
int changeFontFromFilename (int index, char * FontFilename)
{
    ...
    if (fntmgr)
    {
        fontID = (int)fntmgr->changeFontFromFilename(index, FontFilename);
        delete fntmgr;
    }
    return fontID;
}
