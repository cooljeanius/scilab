...
#endif
#endif
],[TCL_VERSION_OK=1],[TCL_VERSION_OK=0])
...
[AC_MSG_WARN([cross-compiling, we do not know what to do for that quite yet...])])
...
dirs="$USER_TCL_LIB_PATH /lib /usr/lib /usr/lib64 /usr/lib/tcl /usr/lib/tcl8.* /shlib /shlib/tcl /shlib/tcl8.* /usr/shlib /shlib/tcl /usr//shlib/tcl8.* /usr/local/lib /usr/local/lib/tcl /usr/local/lib/tcl8.* /usr/local/shlib /usr/X11/lib/tcl /usr/X11/lib/tcl8.* /usr/lib/X11 /usr/lib/X11/tcl /usr/lib/X11/tcl8.* ../lib ../../lib  /usr/local/tcl /usr/tcl /usr/tcl/lib /usr/local/tcl/lib /opt/local/lib /sw/lib/ ."
...
#endif
#endif
],[TK_VERSION_OK=1],[TK_VERSION_OK=0])
...
if test $TK_VERSION_OK = 1; then 
	...
	if $TK_VERSION = "cannot happen"; then
		AC_MSG_ERROR([cannot happen])
        else 
