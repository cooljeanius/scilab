...
#   7. Specify if we want the exact version or greater. (equals or greater
#      by default).
#
#------------------------------------------------------------------------
...
AC_DEFUN([AC_JAVA_CHECK_VERSION_PACKAGE],[
   ...
   AC_JAVA_TRY_COMPILE([$2],[String minVersion="$4";
                            ...
                            ["yes"],[echo "yes"],
                            [AC_MSG_ERROR([Wrong version of $1. Expected at least $4. Found $STDOUT])])
   else
   AC_JAVA_TRY_COMPILE([$2],[String minVersion="$4";
                            $6
                            System.out.println($5);
                            ...
                            ["yes"],[echo "yes"],
                            [AC_MSG_ERROR([Wrong version of $1. Expected exact version $4. Found $STDOUT])])
    fi
