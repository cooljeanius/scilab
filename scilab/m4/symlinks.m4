...
dnl# the real name of the file (for example, if we are looking for javac
dnl# and it is a symlink to /usr/bin/gcj, we want to stay in the java dir
dnl# where javac is found
dnl# 
dnl# VARIABLES SET:
