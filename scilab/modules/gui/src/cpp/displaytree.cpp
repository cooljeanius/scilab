...
{
    return iGetNodeInfo(_iVar, _piCurrentItem,
                        const_cast<char *>(TREE_REF_LABEL), _pszValue);
}
...
{
    return iGetNodeInfo(_iVar, _piCurrentItem,
                        const_cast<char *>(TREE_REF_ICON), _pszValue);
}
...
{
    return iGetNodeInfo(_iVar, _piCurrentItem,
                        const_cast<char *>(TREE_REF_CALL), _pszValue);
}
