...
void FCprintf(FILE*, const char *fmt, ...);
void Fprintf(FILE*, int, const char *fmt, ...);
...
void CheckOptSquare (FILE *f,  VARPTR var, const char *str);
...
extern const char *SGetCDec  (int type);
