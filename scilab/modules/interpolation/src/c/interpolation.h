 ...
 *
 */
#ifndef SCILAB_INTERPOLATION_H
#define SCILAB_INTERPOLATION_H 1
/*--------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------*/
#ifndef INTERPOLATION_ENUMS
#define INTERPOLATION_ENUMS 1
enum interpolation_h_e
{
    NOT_A_KNOT, NATURAL, CLAMPED, PERIODIC, FAST, FAST_PERIODIC,
    MONOTONE, BY_ZERO, C0, LINEAR, BY_NAN, UNDEFINED
};
#endif /* !INTERPOLATION_ENUMS */
/*--------------------------------------------------------------------------*/
typedef struct
{
    char *str_type;
