    ...
    else
    {
        ...
        for (it_commands = this->Commands.begin(); it_commands != this->Commands.end(); ++it_commands)
        {
            std::string line = (*it_commands).get();
            {
                ...
                if (this->my_lines)
                {
                    this->my_lines = static_cast<char **>(REALLOC(this->my_lines,
                                                          i * (sizeof(char *))));
                }
                else
                {
                    this->my_lines = static_cast<char **>(MALLOC(i * (sizeof(char *))));
                }
                ...
                if (this->my_linenumbers)
                {
                    this->my_linenumbers = static_cast<int *>(REALLOC(this->my_linenumbers,
                                           i * (sizeof(int))));
                }
                else
                {
                    this->my_linenumbers = static_cast<int *>(MALLOC(i * (sizeof(int))));
                }
