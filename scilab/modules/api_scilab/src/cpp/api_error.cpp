...
#else
    /* FIXME: proper test should be for whether declaration for gettext() has the
     * format_arg attribute applied to it: */
# ifdef __clang__
    sprintf(pstMsg1, "%s", _("stack size exceeded!\n"));
    sprintf(pstMsg2, "%s", _("Use stacksize function to increase it.\n"));
# else
