...
/* Define to 1 if you have the <wtloop.c> header file. */
/* #undef HAVE_WTLOOP_C */
...
/* libXML2 library */
#define LIBXML_LIBS "-L/opt/local/lib -lxml2 -lz -lpthread -liconv -lm"
...
/* PCRE flags */
#define PCRE_CFLAGS "-I/opt/local/include"

/* PCRE library */
#define PCRE_LIBS "-L/opt/local/lib -lpcreposix -lpcre"

/* PCRE version */
#define PCRE_VERSION "8.33"
...
#define SHARED_LIB_EXT "`test .$module = .yes && echo .so || echo .dylib`"
...
/* Do not use getwd. Instead use getcwd. */
/* #undef getwd */
